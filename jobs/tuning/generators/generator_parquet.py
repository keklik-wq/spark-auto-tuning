...
# Генерация случайных данных для parquet файла
data = []
...
df = pd.DataFrame(data, columns=['surname', 'name', 'patronymic', 'phone', 'street', 'city', 'series_passport', 'number_passport', 'birthday', 'created_dt', 'updated_dt'])

filename = f'tuning/input/parquet_{number_of_rows}/data.parquet'
os.makedirs(os.path.dirname(filename), exist_ok=True)
# Запись данных в parquet файл
df.to_parquet(filename, engine='auto', compression='snappy')
print('Parquet файл успешно сгенерирован')
